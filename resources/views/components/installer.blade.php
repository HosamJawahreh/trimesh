...
<div class="installer-layout" data-bg-image="{{ asset('admin/installer/background.jpg') }}">
        <div class="container-installer">
            <div class="installer-wrapper py-13 min-vh-100 d-flex flex-column align-items-center justify-content-center">
                <div class="installer-header mb-6 text-center">
                    <div class="installer-logo mb-4">
                        <img src="{{ asset('admin/assets/img/logo/logo-white.png') }}" alt="{{ config('app.name') }}">
                    </div>
                ...
                <div class="installer-footer mt-6 text-center">
                    <div class="installer-footer-logo">
                        <img src="{{ asset('admin/assets/img/logo/logo-white.png') }}" alt="{{ config('app.name') }}">
                    </div>
                </div>
            </div>
