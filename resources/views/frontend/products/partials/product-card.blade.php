...
@endphp
<div class="tp-product-item mb-30 h-100 d-flex flex-column">
    <div class="tp-product-item-thumb" style="position: relative; overflow: hidden; border-radius: 12px; background: #f8f9fa;">
       ...
       <a href="{{ route('products.show', $product->slug) }}" style="display: block; height: 280px; overflow: hidden;">
           <img class="w-100 h-100" src="{{ asset($product->image) }}" alt="{{ $product->title }}" style="object-fit: cover; object-position: center; transition: transform 0.3s ease;">
        </a>
    ...
    <div class="tp-product-item-content flex-grow-1 d-flex flex-column">
        <h4 class="tp-product-item-title" style="min-height: 48px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
        ...
        <span class="tp-product-item-price mt-auto">
            @if ($product->isOnSale())
