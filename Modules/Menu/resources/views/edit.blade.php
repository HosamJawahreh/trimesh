        ...
        <div class="col-lg-4">
            <form id="menuBuilderForm" class="form-horizontal">
                <x-card :heading="__('admin.menu_builder')">
                    ...
                    <div class="form-group mb-3">
                        <label for="icon" class="form-label">{{ __('attribute.icon') }} <small class="text-muted">(FontAwesome class)</small></label>
                        <input type="text" name="icon" class="form-control item-menu" id="icon" placeholder="fas fa-home">
                        <small class="form-text text-muted">
                            Visit <a href="https://fontawesome.com/icons" target="_blank">FontAwesome</a> for icon classes. Leave empty for no icon.
                        </small>
                    </div>
                    <div class="form-group mb-3">
