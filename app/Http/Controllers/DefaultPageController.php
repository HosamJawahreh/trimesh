...
class DefaultPageController extends Controller
{
    ...
    public function quote(Request $request)
    {
        ...
        // Get the home_main page to access the process section
        $page = SitePage::where('slug', 'home_main')->with(['sections.translations'])->first();
        $sections = $page?->sections->keyBy('slug');

        // Get process section content
        $section = $sections['process'] ?? null;
